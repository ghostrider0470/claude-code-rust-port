...
use harness_session::{
    ...
    SessionTranscriptSmallestGap,
    SessionTranscriptLastTurn,
    SessionTranscriptMissingTurnCount,
...
impl RuntimeEngine {
    ...
    pub fn has_entries_session_transcript(
        &self,
        selector: &str,
    ) -> Result<SessionTranscriptHasEntries, String> {
        self.store
            .has_entries_transcript(selector)
            .map_err(|err| err.to_string())
    }
    ...
    pub fn turn_range_session_transcript(
        &self,
        selector: &str,
    ...
    pub fn missing_turn_indexes_session_transcript(
        &self,
        selector: &str,
    ...
    pub fn smallest_gap_session_transcript(
        &self,
        selector: &str,
    ) -> Result<SessionTranscriptSmallestGap, String> {
        self.store
            .smallest_gap_transcript(selector)
            .map_err(|err| err.to_string())
    }
    ...
    pub fn missing_turn_count_session_transcript(
        &self,
        selector: &str,
    ) -> Result<SessionTranscriptMissingTurnCount, String> {
        self.store
            .missing_turn_count_transcript(selector)
            .map_err(|err| err.to_string())
    }
